...
if("TRUE" STREQUAL "TRUE")
  set(bms_interface_SOURCE_PREFIX /home/lab16/catkin_ws/src/armadillo/armadillo2_utils/bms_interface)
  set(bms_interface_DEVEL_PREFIX /home/lab16/catkin_ws/src/librealsense-2.10.3/devel)
  ...
  set(bms_interface_INSTALL_PREFIX /usr/local)
...
if(NOT "/home/lab16/catkin_ws/src/armadillo/armadillo2_utils/bms_interface/include " STREQUAL " ")
  set(bms_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/lab16/catkin_ws/src/armadillo/armadillo2_utils/bms_interface/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'bms_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab16/catkin_ws/src/armadillo/armadillo2_utils/bms_interface/${idir}'.  ${_report}")
    endif()
