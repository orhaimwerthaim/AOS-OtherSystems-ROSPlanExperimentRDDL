...
if(NOT "/home/lab16/catkin_ws/src/armadillo/armadillo2_sim_interface/include " STREQUAL " ")
  set(armadillo2_sim_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/lab16/catkin_ws/src/armadillo/armadillo2_sim_interface/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'armadillo2_sim_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab16/catkin_ws/src/armadillo/armadillo2_sim_interface/${idir}'.  ${_report}")
    endif()
