...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/lab16/catkin_ws/src/test)
  set(test_DEVEL_PREFIX /home/lab16/catkin_ws/src/librealsense-2.10.3/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lab16/catkin_ws/src/test/${idir}'.  ${_report}")
    endif()
