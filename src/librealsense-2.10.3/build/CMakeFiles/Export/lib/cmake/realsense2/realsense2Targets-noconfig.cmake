...
set_target_properties(realsense2::realsense2 PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/librealsense2.so.2.10.3"
  IMPORTED_SONAME_NOCONFIG "librealsense2.so.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS realsense2::realsense2 )
list(APPEND _IMPORT_CHECK_FILES_FOR_realsense2::realsense2 "${_IMPORT_PREFIX}/lib/librealsense2.so.2.10.3" )
